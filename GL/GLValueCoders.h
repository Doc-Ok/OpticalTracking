...
#ifndef GLVALUECODERS_INCLUDED
#define GLVALUECODERS_INCLUDED
...
class ValueCoder<GLColor<ScalarParam,3> >
	{
	/* Methods: */
	public:
	static std::string encode(const GLColor<ScalarParam,3>& value);
	static GLColor<ScalarParam,3> decode(const char* start,const char* end,const char** decodeEnd =0);
	};

template <class ScalarParam>
class ValueCoder<GLColor<ScalarParam,4> >
	{
	/* Methods: */
	public:
...
class ValueCoder<GLMaterial>
	...
	static GLMaterial decode(const char* start,const char* end,const char** decodeEnd =0);
	};
