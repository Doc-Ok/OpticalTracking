...
#ifndef SCENEGRAPH_DOOM3MODELNODE_INCLUDED
#define SCENEGRAPH_DOOM3MODELNODE_INCLUDED
...
class Doom3ModelNode:public GraphNode
	{
	/* Embedded classes: */
	public:
	...
	/* Derived state: */
	protected:
	Doom3Model* mesh; // Pointer to the triangle mesh object
	
	/* Constructors and destructors: */
	public:
	Doom3ModelNode(void);
	virtual ~Doom3ModelNode(void);
