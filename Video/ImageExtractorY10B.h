...
#ifndef VIDEO_IMAGEEXTRACTORY10B_INCLUDED
#define VIDEO_IMAGEEXTRACTORY10B_INCLUDED

#include <Video/ImageExtractor.h>

namespace Video {

class ImageExtractorY10B:public ImageExtractor
	{
	/* Elements: */
	private:
	...
	public:
	ImageExtractorY10B(const unsigned int sSize[2]); // Constructs an extractor for the given frame size
